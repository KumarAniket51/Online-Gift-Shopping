...
<a href="index.jsp"><p class="text-left" style="color: blue">HOME</p></a>
  ...
  <div class="card" id="reg" style="height: 880px;width: 600px;margin: 40px 40px 40px 40px;padding: 30px 30px 30px 30px">
      <p style="font-family: sans-serif;font-weight: 700;font-size: 30px;text-align: center;">Customer Register</p>
  ...
  <div class="form-group">
	...
	<div class="form-group">
      ...
      <input type="number" class="form-control" id="Name" placeholder="Enter Number" name="mobileNo">
    </div>
...
<center>  <button type="submit">SUBMIT</button></center>
	...
	<a href="CustomerLogin.html"><p>login now?</p></a>
